...
def selectMapFlappyBird():
    ...
    lives = w.get()
    global root, canvas, bg1, bg2, gr1, gr2, yu, ym, yd, bu, bm, bd, ru, rm, rd, top1, top2, top3, bottom1, bottom2, bottom3, yh, bh, rh, dyh, dbh, drh, sy, sb, sr, Hearts, Scores
    root.destroy()
    root = Tk()
    root.focus_force()
    ...
    for i in range(lives):
        ...
        bh.append(Hearts.create_image(1000, 1000, image = bhImg, anchor="nw"))
        rh.append(Hearts.create_image(1000, 1000, image = rhImg, anchor="nw"))
