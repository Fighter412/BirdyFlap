    ...
    if mode > 0:
        if data[0].get() != "None":
            ...
            if deathStage[0] == 0 and Lives[0] != 0:
                if pos[0][0]>a and pos[0][0]<a+104 or pos[0][0]+60>a and pos[0][0]+60<a+104 or pos[0][0]>b and pos[0][0]<b+104 or pos[0][0]+60>b and pos[0][0]+60<b+104 or ((pos[0][0]-pos[1][0])*(pos[0][0]-pos[1][0])+(pos[0][1]-pos[1][1])*(pos[0][1]-pos[1][1])<24*24 or (pos[0][0]-pos[2][0])*(pos[0][0]-pos[2][0])+(pos[0][1]-pos[2][1])*(pos[0][1]-pos[2][1])<24*24) and bool(data[3].get()):
        ...
        if data[1].get() != "None":
            ...
            if deathStage[1] == 0 and Lives[1] != 0:
                if pos[1][0]>a and pos[1][0]<a+104 or pos[1][0]+60>a and pos[1][0]+60<a+104 or pos[1][0]>b and pos[1][0]<b+104 or pos[1][0]+60>b and pos[1][0]+60<b+104 or ((pos[0][0]-pos[1][0])*(pos[0][0]-pos[1][0])+(pos[0][1]-pos[1][1])*(pos[0][1]-pos[1][1])<24*24 or (pos[1][0]-pos[2][0])*(pos[1][0]-pos[2][0])+(pos[1][1]-pos[2][1])*(pos[1][1]-pos[2][1])<24*24) and bool(data[3].get()):
                    c = [pipes[order[mode][1+mode%2]-1]+640, pipes[order[mode][2+mode%2]-1]+640]
                    d = [pipes[order[mode][1+mode%2]-1]+pipes[order[mode][1+mode%2]+2], pipes[order[mode][2+mode%2]-1]+pipes[order[mode][2+mode%2]+2]]
                    if pos[1][0] < 401:
        ...
        if data[2].get() != "None":
            ...
            if deathStage[2] == 0 and Lives[2] != 0:
                if pos[2][0]>a and pos[2][0]<a+104 or pos[2][0]+60>a and pos[2][0]+60<a+104 or pos[2][0]>b and pos[2][0]<b+104 or pos[2][0]+60>b and pos[2][0]+60<b+104 or ((pos[0][0]-pos[2][0])*(pos[0][0]-pos[2][0])+(pos[0][1]-pos[2][1])*(pos[0][1]-pos[2][1])<24*24 or (pos[1][0]-pos[2][0])*(pos[2][0]-pos[2][0])+(pos[2][1]-pos[2][1])*(pos[2][1]-pos[2][1])<24*242 and bool(data[3].get())):
                    c = [pipes[order[mode][1+mode%2]-1]+640, pipes[order[mode][2+mode%2]-1]+640]
                    d = [pipes[order[mode][1+mode%2]-1]+pipes[order[mode][1+mode%2]+2], pipes[order[mode][2+mode%2]-1]+pipes[order[mode][2+mode%2]+2]]
                    if pos[2][0] < 401:
