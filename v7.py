...
def selectMapFlappyBird():
    global root, canvas, bg1, bg2, gr1, gr2, yu, ym, yd, bu, bm, bd, ru, rm, rd, top1, top2, top3, bottom1, bottom2, bottom3
    ##print(pos)
...
w = Scale(root, from_=0, to=10, orient=HORIZONTAL, length=130)
