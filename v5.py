...
def update_window():
    ...
    if begin:
        if pipes[0] == 2000 :
            pipes[0] = -300#random.randint(-750, -300)
            pipes[1] = -500#random.randint(-750, -300)
            pipes[2] = -700#random.randint(-750, -300)
        array = order[mode]
        ...
        canvas.moveto(bottom1, background[1]-800+400*array.index(1), pipes[0]+790)
        canvas.moveto(bottom2, background[1]-800+400*array.index(2), pipes[1]+790)
        canvas.moveto(bottom3, background[1]-800+400*array.index(3), pipes[2]+790)
