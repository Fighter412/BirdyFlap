    ...
    if mode > 0:
        if data[0].get() != "None":
            ...
            if deathStage[0] == 0 and Lives[0] != 0:
                print(pos[0][0]>a, pos[0][0]<a+104, pos[0][0]+60>a, pos[0][0]+60<a+104, pos[0][0]>b, pos[0][0]<b+104, pos[0][0]+60>b, pos[0][0]+60<b+104)
                if (pos[0][0]>a and pos[0][0]<a+104 or pos[0][0]+60>a and pos[0][0]+60<a+104 or pos[0][0]>b and pos[0][0]<b+104 or pos[0][0]+60>b and pos[0][0]+60<b+104):
                    if not (((pos[0][0]>a or pos[0][0]<a+104) and (pos[0][0]+60>a or pos[0][0]+60<a+104)) or ((pos[0][0]>b or pos[0][0]<b+104) and (pos[0][0]+60>b or pos[0][0]+60<b+104))):
                        print(pos[0][0]>a, pos[0][0]<a+104, pos[0][0]+60>a, pos[0][0]+60<a+104, pos[0][0]>b, pos[0][0]<b+104, pos[0][0]+60>b, pos[0][0]+60<b+104)
                    #if False:
        ...
        if data[1].get() != "None":
            ...
            if deathStage[1] == 0 and Lives[1] != 0:
                if pos[1][0]>a and pos[1][0]<a+104 or pos[1][0]+60>a and pos[1][0]+60<a+104 or pos[1][0]>b and pos[1][0]<b+104 or pos[1][0]+60>b and pos[1][0]+60<b+104:
                    c = [pipes[order[mode][1+mode%2]-1]+640, pipes[order[mode][2+mode%2]-1]+640]
                    d = [pipes[order[mode][1+mode%2]-1]+pipes[order[mode][1+mode%2]+2], pipes[order[mode][2+mode%2]-1]+pipes[order[mode][2+mode%2]+2]]
                    if pos[1][0] < 401:
        ...
        if data[2].get() != "None":
            ...
            if deathStage[2] == 0 and Lives[2] != 0:
                if pos[2][0]>a and pos[2][0]<a+104 or pos[2][0]+60>a and pos[2][0]+60<a+104 or pos[2][0]>b and pos[2][0]<b+104 or pos[2][0]+60>b and pos[2][0]+60<b+104:
                    c = [pipes[order[mode][1+mode%2]-1]+640, pipes[order[mode][2+mode%2]-1]+640]
                    d = [pipes[order[mode][1+mode%2]-1]+pipes[order[mode][1+mode%2]+2], pipes[order[mode][2+mode%2]-1]+pipes[order[mode][2+mode%2]+2]]
                    if pos[2][0] < 401:
